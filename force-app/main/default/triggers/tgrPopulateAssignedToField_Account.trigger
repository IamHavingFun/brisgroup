// This trigger populates the read-only field "Assigned To" on accounts,
// Along with ManagerName
// It's needed for custom reporting

trigger tgrPopulateAssignedToField_Account on Account (before insert, before update) { 
